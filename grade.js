function calculateGrade() {
    ...
    var score1 = document.getElementById("score2").value;
    var score1 = document.getElementById("score2").value;
    ...
    if (isNaN(score1) || score1 < 0 || score1 > 60) {
        alert("กรุณากรอกคะแนนให้ถูกต้อง (0-60)");
        return;
    }
    score1 = parseFloat(score1);
    if (isNaN(score2) || score2 < 0 || score2 > 40) {
        alert("กรุณากรอกคะแนนให้ถูกต้อง (0-40)");
        return;
    }
    var  score1 + score2
